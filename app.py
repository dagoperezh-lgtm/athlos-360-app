...
def generar_word_v35(data, avs_team, avs_hist):
    ...
    hdr = t.rows[0].cells
    hdr[0].text="MÉTRICA"; hdr[1].text="SEM ACTUAL"; hdr[2].text="HIST ANUAL"
...
with st.spinner("Procesando datos..."):
    datos, avs_team, avs_hist, err = cargar_procesar_datos(URL_HISTORICO, URL_SEMANA)
        ...
        if atleta:
            ...
            def mostrar_tabla_web(titulo, keys):
                ...
                def color_col(val):
                    ...
                    elif '-' in str(val): color = 'red'
                    elif 'New' in str(val): color = 'blue'
